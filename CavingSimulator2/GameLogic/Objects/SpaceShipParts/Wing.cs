...
namespace CavingSimulator2.GameLogic.Objects.SpaceShipParts
{
    ...
    {
        public Wing() { }
        public Wing(Transform transform, Quaternion localRotation) : base()
        {
            ImageName = "wingImage";
            ...
            this.renderer.AddMesh(new Mesh(this.transform, "wing"));
        }
        public Wing(Quaternion localRotation) : base()
        {
            ImageName = "wingImage";
        ...
        {
            return new Wing(this.localRotation);
        }
    }
}
